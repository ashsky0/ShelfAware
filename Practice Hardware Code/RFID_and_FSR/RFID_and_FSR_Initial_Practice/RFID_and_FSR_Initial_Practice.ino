...
//             - (x6) MFRC522
// Desciption:
//             This code scnas form 6 different RC522 RFID readers using a daisy chain method and inmplements an FSR.
...
void loop() {
  ...
  delay(100); // debounce / reduce spam
}
...
void read_from_FSR() {
  ...
  if (!objectPresent && diff > THRESHOLD) {
    objectPresent = true;
    Serial0.print("Object added at ");
    Serial0.print(currentTime / 1000.0, 2); // Convert to seconds
    Serial0.print(" seconds with reading of ");
    Serial0.println(reading);
  } 
  else if (objectPresent && diff < THRESHOLD / 2) {
    objectPresent = false;
    Serial0.print("Object removed at ");
    Serial0.print(currentTime / 1000.0, 2);
    Serial0.print(" seconds with reading of ");
    Serial0.println(reading);
  }
}
...
void setup_FSRs() {
  ...
  Serial0.print("Baseline: ");
  Serial0.println(baseline);
}
